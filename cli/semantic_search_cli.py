...
def main():
    ...
    semantic_chunk_parser = subparsers.add_parser("semantic_chunk", help="Creates chunk semantically")
    ...
    match args.command:
        ...
        case "semantic_chunk":
            ss.semantic_chunk(args.text, args.max_chunk_size, args.overlap)
        case _:
            parser.print_help()
